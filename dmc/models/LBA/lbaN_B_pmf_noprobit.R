...
# like p.list.dmc except returns a second
# p.list where PM trial accumulation rates
# are replaced with nonPM trial accumulation rates
# (to remove reactive inhibition)
